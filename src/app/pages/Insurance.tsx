    ...
    <div className="pt-[80px]">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-[800px] mx-auto px-4 text-center">
          <span className="text-[#ffc2d1] uppercase tracking-[2px] text-sm font-semibold mb-4 block">Financial Transparency</span>
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="bg-white p-8 rounded-2xl flex items-center justify-center text-center shadow-sm border border-gray-100 hover:border-[#ffc2d1] transition-colors cursor-default">
          ...
          <div className="mt-12 flex items-center justify-center gap-3 text-gray-500 font-serif italic text-sm text-center">
            <CheckCircle2 className="text-[#ffc2d1]" size={16} />
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-10 rounded-3xl border border-gray-200 bg-white hover:shadow-xl transition-all">
              <div className="p-4 bg-[#ffc2d1]/10 rounded-2xl w-fit text-[#ffc2d1] mb-6">
                <Wallet size={32} />
              </div>
      ...
      {/* CTA Banner */}
      <section className="py-20 bg-[#ffc2d1]">
